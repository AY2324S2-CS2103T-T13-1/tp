...
with(this){return _c('ul',[_c('li',[_v("NUS TAs who has to keep track of students' profile and attendance record during class")]),_v(" "),_c('li',[_v("Has a need to manage a significant number of contacts, including potentially different classes")]),_v(" "),_c('li',[_v("Manages student's profile such as contact information, attendance, etc.")]),_v(" "),_c('li',[_v("Prefer desktop apps over other types")]),_v(" "),_c('li',[_v("Can type fast")]),_v(" "),_c('li',[_v("Prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("Is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Select a class when the program is first opened (UC-01)")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Create new class (UC-02)")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Select a student's profile (UC-03)")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Enter an invalid command.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. MustVas shows an error message.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. Enter an invalid class")]),_v(" "),_c('ul',[_c('li',[_v("1a1. MustVas shows an error message that stated class does not exist.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add a student to a class (UC-04)")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User enters the program (MustVas)")]),_v(" "),_c('li',[_v("User requests to view classes (assuming they've been added) and proceeds to select one.")]),_v(" "),_c('li',[_v("User then inputs the command 'add' to check how to enter command")]),_v(" "),_c('li',[_v("User then inputs details for the command 'add'")]),_v(" "),_c('li',[_v("MustVas then adds the student to the selected class and displays all relevant details in the console.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. User enters invalid details.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. MustVas shows an error message.")])])]),_v(" "),_c('li',[_c('p',[_v("3b. Required fields are left empty.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. MustVas shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sat, 13 Apr 2024, 20:41:20 GMT+8]")])])])}
}];
